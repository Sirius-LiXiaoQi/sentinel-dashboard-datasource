package com.sirius.sentinel.datasource.nacos.controller;
...
/**
 * Degrade rule controller (v3).
 *
 * @author Sirius
 * @since 1.8.6
 */
@RestController
@RequestMapping("/v3/degrade")
public class DegradeControllerV3 {

    private final Logger logger = LoggerFactory.getLogger(DegradeControllerV3.class);

    @Autowired
    @Qualifier("inMemDegradeRuleStore")
