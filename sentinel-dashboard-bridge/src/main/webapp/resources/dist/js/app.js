...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state", function (r, t) {
    ...
    a.interceptors.push("AuthInterceptor"), r.config({
        ...
        resolve: {
            loadMyFiles: ["$ocLazyLoad", function (e) {
                return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/flow_v3.js"]})
            }]
        }
        ...
        templateUrl: "app/views/degrade_v3.html",
        url: "/v3/degrade/:app",
        controller: "DegradeControllerV3",
        resolve: {
            loadMyFiles: ["$ocLazyLoad", function (e) {
                return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/degrade_v3.js"]})
            }]
        }
...
}]),(app = angular.module("sentinelDashboardApp")).service("FlowServiceV3", ["$http", function (a) {
    function t(e) {
        return void 0 === e || "" === e || isNaN(e) || e <= 0
    }

    this.queryMachineRules = function (e, t, r) {
        return a({url: "/v3/flow/rules", params: {app: e, ip: t, port: r}, method: "GET"})
    }, this.newRule = function (e) {
        return a({url: "/v3/flow/rule", data: e, method: "POST"})
    }, this.saveRule = function (e) {
        return a({url: "/v3/flow/rule/" + e.id, data: e, method: "PUT"})
    }, this.deleteRule = function (e) {
        return a({url: "/v3/flow/rule/" + e.id, method: "DELETE"})
...
}]), (app = angular.module("sentinelDashboardApp")).service("DegradeServiceV3", ["$http", function (a) {
    this.queryMachineRules = function (e, t, r) {
        return a({url: "/v3/degrade/rules.json", params: {app: e, ip: t, port: r}, method: "GET"})
    }, this.newRule = function (e) {
        return a({url: "/v3/degrade/rule", data: e, method: "POST"})
    }, this.saveRule = function (e) {
        var t = {
            id: e.id,
            resource: e.resource,
        ...
        return a({url: "/v3/degrade/rule/" + e.id, data: t, method: "PUT"})
    }, this.deleteRule = function (e) {
        return a({url: "/v3/degrade/rule/" + e.id, method: "DELETE"})
    }, this.checkRuleValid = function (e) {
